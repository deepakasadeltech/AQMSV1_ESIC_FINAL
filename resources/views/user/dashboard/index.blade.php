			...
			<div class="row">
				...
				<div class="card-panel doctordashboard">
                    ...
                    <table id="department-table" class="display" cellspacing="0">
                        ...
                        <tbody>
                            @foreach($patient_list_doctorwise->sortBy('number') as $patient)
                        <!---------------------------------------->   
                                <tr>
                                    <td @if($patient->view_status == 1) class="enabled" @else class="disabled"  @endif >{{ $loop->iteration }}</td>
                                    <td  @if($patient->view_status == 1) class="enabled" @else class="disabled"  @endif>{{ $patient->queue->regnumber  }}</td>
                                    ...
                                    <a @if($patient->view_status == 1) class="btn-floating btn waves-effect waves-light deep-purple tooltipped enabled" @else class="btn-floating btn waves-effect waves-light deep-purple tooltipped disabled"  @endif   href="{{url('/dashboard/endCounter')}}/{{$patient->id}}" data-position="top" data-tooltip="{{ trans('messages.end_time') }}"> <i class="mdi-action-schedule"></i></a>
                                   
                                    </td>
                                  
                                  
                                  <td>
                                  @if($patient->view_status == 0) 
