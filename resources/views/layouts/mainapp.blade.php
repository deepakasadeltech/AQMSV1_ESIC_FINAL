                    ...
                    <div class="nav-wrapper">
                       ...
                       <ul><li> <span class="textlogo">IMARECON<sup>&reg;</sup> AUTOMATIC QUEUE MANAGEMENT</span></li></ul>
                        ...
                        <ul class="right responsive_disnone hide-on-med-and-down">
                            ...
                            <li><a href="javascript:void(0);" class="ss waves-effect waves-block waves-light translation-button"  data-activates="translation-dropdown">{{$clocale->name}}</a></li>
                        ...
                        <ul id="translation-dropdown" class="dropdown-content" style="max-height:250px">
                            ...
                            @foreach($languages as $language)
                                <li{!! ($clocale->code==$language->code)?' class="active"':'' !!}><a href="{{ route('change_locale', ['locale' => $language->code]) }}"> <span class="language-select">{{ trans('messages.locales.'.$clocale->code.'.'.$language->code) }}</span></a></li>
                            @endforeach
                        </ul>
